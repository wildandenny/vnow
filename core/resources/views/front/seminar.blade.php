...
@section('breadcrumb-subtitle', "Our Seminar")
@section('breadcrumb-link', "Our Seminar")
                  ...
                  <div class="searchbar-form-section">
                     <form action="{{route('front.blogs', ['category' => request()->input('category'), 'month' => request()->input('month'), 'year' => request()->input('year')])}}" method="GET">
                        <div class="searchbar">
                           ...
                           <input name="term" type="text" placeholder="Search Seminar" value="{{request()->input('term')}}">
                       ...
                       <div class="single-blog">
                          ...
                          <div class="blog-txt">
                            ...
                            @endphp
                             ...
                             <a href="{{route('front.seminardetails', [$blog->slug])}}" class="readmore-btn"><span>{{__('Read More')}}</span></a>
