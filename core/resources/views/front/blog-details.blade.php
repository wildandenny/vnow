...
@section('breadcrumb-title', "Selengkapnya…")
@section('breadcrumb-subtitle', $blog->title)
        ...
        <div class="row">
           <div class="{{$blog->sidebar == 1 ? 'col-lg-7' : 'col-12'}}">
              ...
              <div class="blog-share mb-5">
                 <ul>
                    <li><a href="whatsapp://send?text={{urlencode(url()->current()) }}" data-action="share/whatsapp/share" class="whatsapp-share"><i class="fab fa-whatsapp"></i>Whatsapp</a></li>
