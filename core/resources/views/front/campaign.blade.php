...
@section('breadcrumb-subtitle', "Our Campaign")
@section('breadcrumb-link', "Our Campaign")
                  ...
                  <div class="searchbar-form-section">
                     <form action="{{route('front.blogs', ['category' => request()->input('category'), 'month' => request()->input('month'), 'year' => request()->input('year')])}}" method="GET">
                        <div class="searchbar">
                           ...
                           <input name="term" type="text" placeholder="Search Campaign" value="{{request()->input('term')}}">
                ...
                @if (count($blogs) == 0)
                  <div class="col-md-12">
                    <div class="bg-light py-5">
                      <h3 class="text-center">{{__('NO CAMPAIGN FOUND')}}</h3>
                    </div>
                  </div>
                @else
