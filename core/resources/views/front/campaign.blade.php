...
@section('breadcrumb-subtitle', "Kampanye")
@section('breadcrumb-link', "Kampanye")
                  ...
                  <div class="searchbar-form-section">
                     <form action="{{route('front.blogs', ['category' => request()->input('category'), 'month' => request()->input('month'), 'year' => request()->input('year')])}}" method="GET">
                        <div class="searchbar">
                           ...
                           <input name="term" type="text" placeholder="Cari Kampanye" value="{{request()->input('term')}}">
                ...
                @if (count($blogs) == 0)
                  <div class="col-md-12">
                    <div class="bg-light py-5">
                      <h3 class="text-center">Tidak ada aktivitas kampanye ditemukan</h3>
                    </div>
                  </div>
                @else
                       ...
                       <div class="single-blog">
                          ...
                          <div class="blog-txt">
                            ...
                            @endphp
                             ...
                             <h4 class="blog-title"><a href="{{route('front.campaigndetails', [$blog->slug])}}">{{strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title}}</a></h4>
                             ...
                             <a href="{{route('front.campaigndetails', [$blog->slug])}}" class="readmore-btn"><span>{{__('Read More')}}</span></a>
