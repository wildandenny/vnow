                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form
                        ...
                        action="{{route('admin.course_category.delete')}}"
                        method="post"
                      >
                        @csrf
                        <input
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form
          ...
          action="{{route('admin.course_category.store')}}"
          method="POST"
        >
          @csrf
          ...
          <div class="form-group">
            ...
            <p
              ...
              class="mb-0 text-danger em"
            ></p>
            <p class="text-warning"><small>The higher the serial number is, the later the course category will be shown.</small></p>
          </div>
        </form>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form
          id="ajaxEditForm"
          class=""
          action="{{route('admin.course_category.update')}}"
          method="POST"
        >
          @csrf
          <input
            id="incourse_category_id"
            type="hidden"
            name="course_category_id"
            value=""
          >
